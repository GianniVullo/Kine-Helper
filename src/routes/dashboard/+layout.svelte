<script>
	...
	import SignOutIcon from '../../lib/ui/svgs/SignOutIcon.svelte';
...
<!-- <div class="flex w-screen h-screen flex-col md:flex-row">
	...
	<div class="flex h-screen w-full flex-col justify-between">
		<section class="pl-2 h-full mt-2 overflow-scroll">
			<slot />
		</section>
		<footer
			class="h-8 w-full  justify-end border-t border-surface-300 bg-surface-200 px-1 shadow-inner flex text-surface-600">
			Online status :
		</footer>
	</div>
</div> -->
