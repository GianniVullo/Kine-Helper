<script>
	import { dureeParGroupeParLieu, durees, groupes } from '$lib/stores/codeDetails';
	import SimpleSelect from './SimpleSelect.svelte';
	import { get } from 'svelte/store';
	import { t } from '$lib/i18n';
	import { untrack } from 'svelte';
	import PathologieLourdeFields from './PathologieLourdeFields.svelte';
	...
	<div class="col-span-full">
		<Field
			field={{
				...
				outerCSS: 'sm:col-span-4',
				innerCSS: '',
				label: get(t)('form.generateur', 'amb_hos'),
				options: [
					{ value: 'AMB', label: 'AMB' },
					{ value: 'HOS', label: 'HOS' }
				]
